    ...
    return (
        <Section id="contact" title="Contact" type="systems">
            <div className="contact-grid">
                <a href="https://wa.me/2349164703407" target="_blank" rel="noopener noreferrer" className="contact-card whatsapp" aria-label="WhatsApp">
                ...
                <a href="https://www.instagram.com/devluxe_tech/#" target="_blank" rel="noopener noreferrer" className="contact-card instagram" aria-label="Instagram">
                    <div className="contact-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="mailto:mal4crypt404@gmail.com" className="contact-card email" aria-label="Email">
                    <div className="contact-icon">
                        <svg viewBox="0 0 24 24" fill="currentColor">
